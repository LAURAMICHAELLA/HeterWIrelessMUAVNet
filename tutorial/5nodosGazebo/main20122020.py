...
while True:
    ...
    for uav_id, (lat, lon, alt, heading, timestamp) in uav_positions.items():
        if uav_id == 0:
            ...
            MissionPoint = LocationGlobalRelative(-27.603978,-48.517877,target_altitude) #49.94
            ...
            lon = vehicle.location.global_relative_frame.lon
            startMissionPoint = LocationGlobalRelative(lat, lon, target_altitude)
            pointA = LocationGlobalRelative(-27.60368,-48.51758, target_altitude) #82,41m
            pointB = LocationGlobalRelative(-27.60348,-48.51780, target_altitude) #-37,65 #74.48
            vehicle.simple_goto(startMissionPoint)
            ...
            lon = vehicle.location.global_relative_frame.lon
            startMissionPoint = LocationGlobalRelative(lat, lon, target_altitude)
            MissionPoint = LocationGlobalRelative(-27.603312, -48.518091, target_altitude) #72.90
            vehicle.simple_goto(startMissionPoint)
            ...
            lon = vehicle.location.global_relative_frame.lon
            startMissionPoint = LocationGlobalRelative(lat, lon, target_altitude)
            pointA = LocationGlobalRelative(-27.603341,-48.518038,target_altitude) #72,82 m
            pointB = LocationGlobalRelative(-27.60320,-48.51831, target_altitude) #35,54 #78,69
            vehicle.simple_goto(startMissionPoint)
            ...
            lon = vehicle.location.global_relative_frame.lon
            startMissionPoint = LocationGlobalRelative(lat, lon, target_altitude)
            MissionPoint = LocationGlobalRelative(-27.603027,-48.518381,target_altitude) #99,47m
            vehicle.simple_goto(startMissionPoint)
...
sys.exit("End of experiment scenario 5 nodos!")
