...
#ns3-dev-external-sync-wifi-adhoc --num-ext-nodes=5&
#interfaceManagerPlusGazeboversion0.2 --numberOfNodes=5 --simulationTime=146.0 &
homogenousCommunication25022021commGazebo --NumberOfInterfaces=2 --numberOfNodes=5 --simulationTime=140 & 
