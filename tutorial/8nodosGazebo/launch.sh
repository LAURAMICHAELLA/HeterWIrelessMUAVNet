...
#interfaceManagerPlusGazeboversion0.1 --numberOfNodes=8 --simulationTime=146.0 &
homogenousCommunication25022021commGazebo --NumberOfInterfaces=2 --numberOfNodes=8 --simulationTime=135 & 
