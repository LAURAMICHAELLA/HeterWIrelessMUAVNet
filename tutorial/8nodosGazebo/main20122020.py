...
while True:
    ...
    for uav_id, (lat, lon, alt, heading, timestamp) in uav_positions.items():
        if uav_id == 0:
            ...
            MissionPoint = LocationGlobalRelative(-27.60392,-48.51788,target_altitude) #46,53m
            ...
            lon = vehicle.location.global_relative_frame.lon
            startMissionPoint = LocationGlobalRelative(lat, lon, target_altitude)
            MissionPoint = LocationGlobalRelative(-27.60349,-48.51794,target_altitude) #40 x e 63 para y
            vehicle.simple_goto(startMissionPoint)
            ...
            lon = vehicle.location.global_relative_frame.lon
            startMissionPoint = LocationGlobalRelative(lat, lon, target_altitude)
            MissionPoint = LocationGlobalRelative(-27.60303,-48.51838,target_altitude) #70m
            vehicle.simple_goto(startMissionPoint)
            ...
            lon = vehicle.location.global_relative_frame.lon
            startMissionPoint = LocationGlobalRelative(lat, lon, target_altitude)
            MissionPoint = LocationGlobalRelative(-27.60324,-48.51905,target_altitude) #100,41m
            vehicle.simple_goto(startMissionPoint)
            ...
            lon = vehicle.location.global_relative_frame.lon
            startMissionPoint = LocationGlobalRelative(lat, lon, target_altitude)
            MissionPoint = LocationGlobalRelative(-27.60366, -48.51887, target_altitude) #46,78
            vehicle.simple_goto(startMissionPoint)
            ...
            lon = vehicle.location.global_relative_frame.lon
            startMissionPoint = LocationGlobalRelative(lat, lon, target_altitude)
            MissionPoint = LocationGlobalRelative(-27.60384,-48.51892,target_altitude) #70m
            vehicle.simple_goto(startMissionPoint)
            ...
            lon = vehicle.location.global_relative_frame.lon
            startMissionPoint = LocationGlobalRelative(lat, lon, target_altitude)
            MissionPoint = LocationGlobalRelative(-27.60350,-48.51895,target_altitude) #100,41m
            vehicle.simple_goto(startMissionPoint)
        ...
        #     lon = vehicle.location.global_relative_frame.lon
        #     startMissionPoint = LocationGlobalRelative(lat, lon, target_altitude)
        #     MissionPoint = LocationGlobalRelative(-27.604724, -48.518198, target_altitude) #46,78
	...
	# 	lon = vehicle.location.global_relative_frame.lon
	# 	startMissionPoint = LocationGlobalRelative(lat, lon, target_altitude)
	# 	MissionPoint = LocationGlobalRelative(-27.604325, -48.518932, target_altitude) #46,78
...
#  if end1==1 and end2==1 and end3==1 and end4==1 and end5==1 and end6==1 and end7==1:
 #   		sys.exit("End of experiment scenario 8 nodos!")
